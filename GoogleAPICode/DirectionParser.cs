...
namespace CarpoolGMaps.Helpers
{
    ...
    {
        publi double lat { get; set; }
        publi double lng { get; set; }
    }
    ...
    {
        public IList<GeocodeWaypoint> geocoded_waypoints { get; set; }
